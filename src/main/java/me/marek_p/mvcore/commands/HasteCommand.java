        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                ...
                if (player.hasPermission("mvcore.haste")) {
                    ...
                    player.sendMessage(ChatColor.DARK_GRAY + "[" + ChatColor.AQUA + "Mineverse" + ChatColor.DARK_GRAY + "] " + ChatColor.RED + "You need permission " + ChatColor.DARK_RED + "mvcore.haste" + ChatColor.RED + " to execute this command!");
                }
                ...
                if (player.hasPermission("mvcore.hasteothers")) {
                    ...
                    player.sendMessage(ChatColor.DARK_GRAY + "[" + ChatColor.AQUA + "Mineverse" + ChatColor.DARK_GRAY + "] " + ChatColor.RED + "You need permission " + ChatColor.DARK_RED + "mvcore.hasteothers" + ChatColor.RED + " to execute this command!");
                }
            }
        }
        return true;
